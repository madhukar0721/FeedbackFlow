...
const features = [
  ...
  {
    title: 'Customizable',
    description: 'Customize Feedback Floww to fit your needs and preferences.',
    icon: 'icon-2',
  },
  {
    title: 'Analytics',
  ...
  {
    title: 'Secure',
    description: 'Your data is safe and secure with Feedback Floww.',
  },
  {
    title: 'Scalable',
    description: 'Grow your business with Feedback Floww as you scale.',
  },
  {
    title: 'Fast Support',
